...
generate_fields(Fields, FldMap, #state{var_sfx=SFX} = State) ->
  ...
  ok  = write_file(erlang, src, State, FN2++".app.src", [], [
    "{application, fix", SFX, ",\n"
    "[\n"
    "  {description, \"FIX", Dsc, " library\"},\n"
    "  {vsn, \"1.0\"},\n"
    "  {registered, []},\n"
...
note(Type, #state{base_dir = IsBaseDir, copyrt = Copyright, copyyr = Year}) ->
  ...
  [
    ...
    C, "     *** This file is auto-generated by https://github.com/saleyn/fix ***\n",
    C, "                      *** DON'T MODIFY BY HAND!!! ***\n",
    sep(Type, 0), "\n"
  ].
