...
usage() ->
  io:format(
    ...
    "\n"
    "In order for this script to be able to process log files of a FIX variant\n"
    "the path to the FIX variant application must be added to this resource file:\n"
    "\n"
    "  ~~/.config/fixdumprc\n"
    "  ===================\n"
    "  [\n"
